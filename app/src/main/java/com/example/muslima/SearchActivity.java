...
public class SearchActivity extends AppCompatActivity {
 ...
 spinner_age1 = findViewById(R.id.spinner_age1);
        ...
        list_age.add("18");
        list_age.add("19"); list_age.add("20");
        list_age.add("21"); list_age.add("22");
        list_age.add("23"); list_age.add("24");
        list_age.add("25"); list_age.add("26");
        list_age.add("27"); list_age.add("28");
        list_age.add("29"); list_age.add("30");
        list_age.add("31"); list_age.add("32");
        list_age.add("33"); list_age.add("34");
        list_age.add("35"); list_age.add("36");
        list_age.add("37"); list_age.add("38");
        list_age.add("39"); list_age.add("40");
        list_age.add("41"); list_age.add("42");
        list_age.add("43"); list_age.add("44");
        list_age.add("45"); list_age.add("46");
        list_age.add("47"); list_age.add("48");
        list_age.add("49"); list_age.add("50");
        list_age.add("51"); list_age.add("52");
        list_age.add("53"); list_age.add("54");
        list_age.add("55"); list_age.add("56");
        list_age.add("57"); list_age.add("58");
        list_age.add("59"); list_age.add("60");
        list_age.add("61"); list_age.add("62");
        list_age.add("63"); list_age.add("64");
        list_age.add("65"); list_age.add("66");
        list_age.add("67"); list_age.add("68");
        list_age.add("69"); list_age.add("70");
        list_age.add("71"); list_age.add("72");
        list_age.add("73"); list_age.add("74");
        list_age.add("75"); list_age.add("76");
        list_age.add("77"); list_age.add("78");
        list_age.add("79"); list_age.add("80");
        ...
        list_age2.add("18");
        list_age2.add("19"); list_age2.add("20");
        list_age2.add("21"); list_age2.add("22");
        list_age2.add("23"); list_age2.add("24");
        list_age2.add("25"); list_age2.add("26");
        list_age2.add("27"); list_age2.add("28");
        list_age2.add("29"); list_age2.add("30");
        list_age2.add("31"); list_age2.add("32");
        list_age2.add("33"); list_age2.add("34");
        list_age2.add("35"); list_age2.add("36");
        list_age2.add("37"); list_age2.add("38");
        list_age2.add("39"); list_age2.add("40");
        list_age2.add("41"); list_age2.add("42");
        list_age2.add("43"); list_age2.add("44");
        list_age2.add("45"); list_age2.add("46");
        list_age2.add("47"); list_age2.add("48");
        list_age2.add("49"); list_age2.add("50");
        list_age2.add("51"); list_age2.add("52");
        list_age2.add("53"); list_age2.add("54");
        list_age2.add("55"); list_age2.add("56");
        list_age2.add("57"); list_age2.add("58");
        list_age2.add("59"); list_age2.add("60");
        list_age2.add("61"); list_age2.add("62");
        list_age2.add("63"); list_age2.add("64");
        list_age2.add("65"); list_age2.add("66");
        list_age2.add("67"); list_age2.add("68");
        list_age2.add("69"); list_age2.add("70");
        list_age2.add("71"); list_age2.add("72");
        list_age2.add("73"); list_age2.add("74");
        list_age2.add("75"); list_age2.add("76");
        list_age2.add("77"); list_age2.add("78");
        list_age2.add("79"); list_age2.add("80");
      ...
      spinner_country1 = findViewById(R.id.spinner_country1);
        ...
        list_distance.add("50 kms");list_distance.add("100 kms");list_distance.add("250 kms");list_distance.add("500 kms");
        ...
        list_active.add("Any");
        list_active.add("within week");list_active.add("within 1 month");list_active.add("within 3 month");list_active.add("within 6 month");list_active.add("within year");
...
spinner_sortresult=findViewById(R.id.spinner_sortresult);
        ...
        list_result.add("Photos First"); list_result.add("Last Active");
